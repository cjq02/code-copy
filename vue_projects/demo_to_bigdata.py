...
ORIGIN_PACKAGE_SIGN = 'demo'
TARGET_PACKAGE_SIGN = 'bigdata'
ORIGIN_PROJECT_PATH = 'D:/sizai/git/demo-vue/{sign}-'.format(sign = ORIGIN_PACKAGE_SIGN)
TARGET_PROJECT_PATH = 'D:/sizai/git/policy-big-data/{sign}-'.format(sign = TARGET_PACKAGE_SIGN)
