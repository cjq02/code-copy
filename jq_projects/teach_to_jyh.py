...
ORIGIN_PROJECT_NAME = 'teach'
TARGET_PROJECT_NAME = 'jyh'
ORIGIN_PACKAGE_SIGN = 'teach'
TARGET_PACKAGE_SIGN = 'jyh'
ORIGIN_PROJECT_PATH = 'D:/sizai/git/teach-plat/{sign}-'.format(sign = ORIGIN_PROJECT_NAME)
TARGET_PROJECT_PATH = 'D:/sizai/git/jyh/{sign}-'.format(sign = TARGET_PROJECT_NAME)
ORIGIN_SYS_DIR = 'sys'
TARGET_SYS_DIR = 'sys'
