FILE_PATH_LIST = [
    ...
    # 'web/src/main/java/com/jiujie/{sign}/application/exception/BmsExceptionHandler.java',
    ...
    'vue/src/views/file/fileArchive/FileArchive.vue',
    'vue/src/views/file/fileClassify/FileClassify.vue',
    'vue/src/views/file/fileMaintenance/FileMaintenance.vue',
